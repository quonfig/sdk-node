...
If you believe you have found a security vulnerability in `@quonfig/node`, please report it
...
- The version of `@quonfig/node` you tested against (`npm ls @quonfig/node`)
...
- The published `@quonfig/node` package on npm
